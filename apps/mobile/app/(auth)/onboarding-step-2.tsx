...
const background = require('../../assets/images/figma-info-step-2.png');

const optionTops = ['30.3%', '39.4%', '48.5%', '57.7%', '66.9%', '76.1%'] as const;
    ...
    <SafeAreaView style={styles.safeArea} edges={['top', 'bottom']}>
      <ImageBackground source={background} style={styles.background} resizeMode="stretch">
        <View style={styles.overlay}>
          ...
          {selectedIndex !== null ? (
            <TouchableOpacity style={styles.bottomButton} onPress={() => router.push('/(auth)/onboarding-step-3')}>
